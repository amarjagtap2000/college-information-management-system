...
from .forms import Upload_DocumentForm
from .models import Upload_Document
...
from django.shortcuts import render
#from college.models import City
...
def admin_signup_view(request):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            return render(request,'college/success.html')
...
def student_signup_view(request):
    ...
    if request.method=='POST':
        ...
        return render(request,'college/success1.html')
...
def upload(request):
	if request.method == "POST":
		form = Upload_DocumentForm(request.POST, request.FILES)
		if form.is_valid():
			form.save()
		return redirect("college:upload")
	form = Upload_DocumentForm()
	movies = Upload_Document.objects.all()
	return render(request=request, template_name="college/upload.html", context={'form':form, 'movies':movies})
...
def teacher_signup_view(request):
    ...
    if request.method=='POST':
        ...
        return render(request,'college/success2.html')
